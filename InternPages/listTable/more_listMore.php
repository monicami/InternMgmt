...
<div class="data-action">
	<table class="action-button-table">
		<td class="action-button">
			...
			<td class="action-button-text"><a href="../insertData/edu_addForm.php">Add Record</a></td>
			<td class="action-button-pic"><img src="../images/t02.png" /></td>
			<td class="action-button-text"><a href="../updateData/edu_updateForm.php">Edit</a></td>
		</td>
	</table>
</div>
<br>
...
?> 
 ...
 <div class="data-action">
	<table class="action-button-table">
		<td class="action-button">
			<td class="action-button-pic"><img src="../images/t01.png" /></td>
			<td class="action-button-text"><a href="../insertData/skill_addForm.php">Add Record</a></td>
			<td class="action-button-pic"><img src="../images/t02.png" /></td>
			<td class="action-button-text"><a href="../updateData/skill_updateForm.php">Edit</a></td>
		</td>
	</table>
</div>
<br>
...
<div class="data-action">
	<table class="action-button-table">
		<td class="action-button">
			<td class="action-button-pic"><img src="../images/t01.png" /></td>
			<td class="action-button-text"><a href="../insertData/work_addForm.php">Add Record</a></td>
			<td class="action-button-pic"><img src="../images/t02.png" /></td>
			<td class="action-button-text"><a href="../updateData/work_updateForm.php">Edit</a></td>
		</td>
	</table>
</div>
<br>
...
<br><br>
 ...
 <div class="data-action">
	<table class="action-button-table">
		<td class="action-button">
			<td class="action-button-pic"><img src="../images/t01.png" /></td>
			<td class="action-button-text"><a href="../nsertData/cer_addForm.php">Add Record</a></td>
			<td class="action-button-pic"><img src="../images/t02.png" /></td>
			<td class="action-button-text"><a href="../updateData/cer_updateForm.php">Edit</a></td>
		</td>
	</table>
</div>
<br>
